...
int LinkedList::getRemoveFront()//removes from the front of the linked list and returns the value
{
    int frontValue = m_front->getValue();;
        if(isEmpty())
        {
                return (-1);
        }
